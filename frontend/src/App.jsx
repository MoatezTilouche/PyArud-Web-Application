...
const EXAMPLES = {
  mutakarib: "أَسِرْبَ القَطَا هَلْ مَنْ يُعِيرُ جَنَاحَهُ\nلَعَلِّي إِلَى مَنْ قَدْ هَوِيتُ أَطِيرُ",
  kamil: "صَبَرًا فِي مَجَالِ الْمَوْتِ صَبْرًا جَمِيلًا\nفَمَا نَيْلُ الْمُنَى بِالتَّمَنِّي",
  taweel: "أَرَاكَ عَصِيَّ الدَّمْعِ شِيمَتُكَ الصَّبْرُ\nأَمَا لِلْهَوَى نَهْيٌ عَلَيْكَ وَلَا أَمْرُ"
};
